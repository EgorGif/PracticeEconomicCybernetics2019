...
public class MeetingOffer implements Serializable{
    ...
    public static boolean isEqual(MeetingOffer o1, MeetingOffer o2) {
        return Objects.equals(o1.getFromWho(), o2.getFromWho()) && Objects.equals(o1.getTime().getValue(),
                o2.getTime().getValue()) && Objects.equals(o1.getTime().getKey(), o2.getTime().getKey());
    }
}