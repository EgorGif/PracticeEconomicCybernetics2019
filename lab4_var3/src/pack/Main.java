...
public class Main extends JFrame implements Printable {
    ...
    private Main() {
        this.setTitle("Grpahic Frame");
        this.setSize(500, 600);
        initComponents();
        textLines = initTextLines(new File("src/lab4/Strofoid.java"));
    }
    ...
    private void initComponents() {
        jPanel1 = new JPanel() {
            ...
            public void paintComponent(Graphics g) {
                ...
                g2.draw(new Line2D.Double(0, h / 2, getWidth(), h / 2));
                g2.draw(new Line2D.Double(w / 2, 0, w / 2, getHeight()));
                g2.setColor(Color.BLACK);
                g2.drawString("X", getWidth() - 15, h / 2 - 10);
                g2.drawString("Y", w / 2 + 15, 15);
                g2.setPaint(Color.black);
                g2.setStroke(new MyStroke(15,15));
                g2.draw(new Strofoid(90,w/2 - 100,h/2 - 10));
            }
        }
        ;
