 ...
 **/
public class MainDragAndDrop extends JComponent implements DragGestureListener, // For
        // recognizing
        // the
        // start
        // of
        ...
        MouseMotionListener // For processing mouse drags
{
    ...
    ArrayList<Strofoid> leafs = new ArrayList<Strofoid>();
    // A list of Scribbles to draw
    Strofoid currentScribble; // The scribble in progress
    Strofoid beingDragged; // The scribble being dragged
    ...
    public void paintComponent(Graphics g)
    {
        ...
        g2.setStroke(new MyStroke(15,15)); // Specify wide lines

        int numScribbles = leafs.size();
        for (int i = 0; i < numScribbles; i++)
        {
            Strofoid s = leafs.get(i);
    ...
    public void mousePressed(MouseEvent e)
    {
        if (dragMode)
            return;
        currentScribble = new Strofoid(e.getX(), e.getY(), 100, 100);
    ...
    public void dragGestureRecognized(DragGestureEvent e)
    {
        ...
        { // Loop through the scribbles
            ...
            if (s.intersects(r))
            {
                ...
                Strofoid dragScribble = (Strofoid) s.clone();
    ...
    {
        if (e.isDataFlavorSupported(Strofoid.decDataFlavor) || e.isDataFlavorSupported(DataFlavor.stringFlavor))
        {
    ...
    public void drop(DropTargetDropEvent e)
    {
        ...
        Strofoid droppedScribble; // This will hold the Scribble object

        // First, try to get the data directly as a scribble object
        try
        {
            droppedScribble = (Strofoid) t.getTransferData(Strofoid.decDataFlavor);
        } catch (Exception ex)
        { // unsupported flavor, IO exception, etc.
            ...
            try
            {
                ...
                droppedScribble = Strofoid.getFromString(s);
            } catch (Exception ex2)
            {
    ...
    public static void main(String[] args)
    {
        ...
        final MainDragAndDrop scribblePane = new MainDragAndDrop();
        ...
        final MainDragAndDrop scribblePane2 = new MainDragAndDrop();
